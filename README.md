...
<head>
  ...
  <title>Eduardo Cayky - Criador de Conteúdo com IA</title>
  <style>
    * {
      margin: 0;
      padding: 0;
    ...
    body {
      ...
      background: linear-gradient(135deg, #0a0e27 0%, #1a1a3e 50%, #0f1d3a 100%);
      color: #e0e0e0;
      line-height: 1.6;
      min-height: 100vh;
      overflow-x: hidden;
    ...
    .logo {
      font-size: 2rem;
      font-weight: 900;
      background: linear-gradient(45deg, #00ff88, #64c8ff);
    ...
    nav a::after {
      ...
      width: 0;
      height: 2px;
      background: linear-gradient(90deg, #00ff88, #64c8ff);
    ...
    .hero h1 {
      ...
      background: linear-gradient(45deg, #00ff88, #64c8ff, #ff006e, #64c8ff, #00ff88);
      background-size: 400% 400%;
      -webkit-background-clip: text;
      -webkit-text-fill-color: transparent;
      background-clip: text;
      animation: gradient 6s ease infinite, glow-text 3s ease infinite;
      font-weight: 900;
      line-height: 1.2;
      letter-spacing: -1px;
    }
    ...
    .btn-primary {
      background: linear-gradient(45deg, #00ff88, #64c8ff);
      color: #0a0e27;
      box-shadow: 0 0 40px rgba(0, 255, 136, 0.5), 0 0 80px rgba(100, 200, 255, 0.3);
      font-weight: 700;
    ...
    .btn-primary:hover {
      ...
      box-shadow: 0 0 60px rgba(0, 255, 136, 0.8), 0 0 120px rgba(100, 200, 255, 0.5);
    }
    ...
    .service-card {
      background: linear-gradient(135deg, rgba(100, 200, 255, 0.08) 0%, rgba(255, 0, 110, 0.03) 100%);
    ...
    .service-card:hover {
      border-color: #00ff88;
      background: linear-gradient(135deg, rgba(0, 255, 136, 0.15) 0%, rgba(100, 200, 255, 0.08) 100%);
      transform: translateY(-15px);
      box-shadow: 0 30px 60px rgba(0, 255, 136, 0.2), 0 0 40px rgba(100, 200, 255, 0.15);
    }
    ...
    .price-card {
      background: linear-gradient(135deg, rgba(26, 26, 46, 0.6) 0%, rgba(15, 20, 40, 0.8) 100%);
    ...
    .price-card.featured {
      border: 2px solid #00ff88;
      box-shadow: 0 0 50px rgba(0, 255, 136, 0.4), 0 0 100px rgba(100, 200, 255, 0.2);
      transform: scale(1.08);
      background: linear-gradient(135deg, rgba(0, 255, 136, 0.1) 0%, rgba(100, 200, 255, 0.08) 100%);
    }

    .price-card:hover {
      border-color: #00ff88;
      background: linear-gradient(135deg, rgba(0, 255, 136, 0.08) 0%, rgba(100, 200, 255, 0.12) 100%);
    ...
    @keyframes glow-text {
      0%, 100% { text-shadow: 0 0 20px rgba(100, 200, 255, 0.3), 0 0 40px rgba(255, 0, 110, 0.1); }
      50% { text-shadow: 0 0 30px rgba(100, 200, 255, 0.6), 0 0 60px rgba(255, 0, 110, 0.3); }
    }
...
<body>
  ...
  <section class="pricing" id="pricing">
    ...
    <div class="pricing-cards">
      ...
      <div class="price-card">
        ...
        <a href="https://wa.me/5594999081542?text=Olá! Gostaria de contratar o plano Ouro (R$ 89,90) - 8 Fotos + Design" target="_blank" class="btn btn-secondary">Solicitar</a>
      </div>

      <div class="price-card featured">
        <h3>Vídeos</h3>
        <div class="price-value">R$ 129,90</div>
        <ul class="price-features">
          <li>2 Vídeos profissionais</li>
          <li>Duração até 30s cada</li>
          <li>Edição completa</li>
          <li>Revisões ilimitadas</li>
          <li>Entrega em 48h</li>
        </ul>
        <a href="https://wa.me/5594999081542?text=Olá! Gostaria de contratar o plano Vídeos (R$ 129,90) - 2 Vídeos profissionais" target="_blank" class="btn btn-primary">Começar Agora</a>
      </div>
      ...
      <div class="price-card">
        ...
        <a href="https://wa.me/5594999081542?text=Olá! Gostaria de contratar o plano Diamante (R$ 149,90) - 12 Fotos + Design + Estratégia" target="_blank" class="btn btn-secondary">Contratar</a>
      </div>
    </div>
  </section>
  ...
  <section class="contact" id="contact">
    ...
    <div style="background: linear-gradient(45deg, rgba(0, 255, 136, 0.15), rgba(100, 200, 255, 0.1)); border: 2px solid rgba(0, 255, 136, 0.3); border-radius: 15px; padding: 2rem; margin-top: 3rem;">
      <h3 style="color: #00ff88; margin-bottom: 1rem;">Pronto para começar?</h3>
      ...
      <a href="https://wa.me/5594999081542?text=Olá Eduardo! Vim pelo seu site e gostaria de conhecer seus serviços!" target="_blank" class="btn btn-primary">💬 Conversar no WhatsApp</a>
    </div>
  </section>
